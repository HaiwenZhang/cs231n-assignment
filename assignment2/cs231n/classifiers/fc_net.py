...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dx_layer2, dw2, db2 = affine_backward(softmax_grad, layer2_cache)
        
        _, dw1, db1 = affine_relu_backward(dx_layer2, layer1_cache)
...
class FullyConnectedNet(object):
    ...
    def __init__(
        ...
        for i in range(self.num_layers):
            W_name = "W" + str(i+1)
            b_name = "b" + str(i+1)
            layer_input_dim = layers_dims[i]
            layer_output_dim = layers_dims[i+1]
                
            self.params[W_name] = np.random.normal(scale=weight_scale, size=(layer_input_dim, layer_output_dim))
            self.params[b_name] = np.zeros((layer_output_dim,))
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers - 1):
            ...
            layer_out, layer_cache = affine_relu_forward(layer_out, W, b)
